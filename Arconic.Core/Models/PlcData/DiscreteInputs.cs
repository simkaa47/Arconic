...
public class DiscreteInputs
{
    ...
    #endregion
    #region Образец 5 мм снят
    public Parameter<bool> SqGateOpen1 { get; } =
        new Parameter<bool>("Образец 5 мм снят", false, true, DataType.Input,  0, 15, 2);
    #endregion
    #region Датчик поставленного дополнительного затвора 2
    public Parameter<bool> SqGateClose1 { get; } =
        new Parameter<bool>("Образец 5 мм поставлен", false, true, DataType.Input,  0, 15, 3);
    #endregion
    #region Датчик снятого дополнительного затвора 1
    public Parameter<bool> SqGateOpen2 { get; } =
        new Parameter<bool>("Образец 10 мм снят", false, true, DataType.Input,  0, 15, 4);
    #endregion
    #region Датчик открытого дополнительного затвора 2
    public Parameter<bool> SqGateClose2 { get; } =
        new Parameter<bool>("Образец 10 мм поставлен", false, true, DataType.Input,  0, 15, 5);
    #endregion
