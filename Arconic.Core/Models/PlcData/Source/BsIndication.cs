...
public class BsIndication()
{
    public Parameter<float> Voltage { get; } = new Parameter<float>("Текущее значение напряжения генератора, кВ", float.MinValue,
        float.MaxValue, DataType.DataBlock, 2, 0, 0){ IsReadOnly = true };
