...
public class PlcEventsData
{
    ...
    [
        ...
        new PlcEvent("Нажата кнопка \"ВКЛ/ОТКЛ Питания HV\" на ЛПУ",ParameterBase.IndicationDbNum,802, 3),
        new PlcEvent("Отжата кнопка \"ВКЛ/ОТКЛ Питания HV\" на ЛПУ",ParameterBase.IndicationDbNum,802, 4),
